...
if __name__ == "__main__":
    ...
    train_dataset = Dataset(train_image_path, train_label_path, image_transform=image_transform, label_transform=label_transform)
    test_dataset = Dataset(test_image_path, test_label_path, image_transform=image_transform, label_transform=label_transform)
